...
const Form = () => {
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Button style={{background:'#009688',color:'white',margin:'20px',float:'right'}} className={classes.button} variant="outlined" color="primary" fullWidth onClick={createAction}>Create</Button>
        </Grid>
    )
}
