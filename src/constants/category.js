...
const workoutColors = ['#123123', '#154731', '#165f40', '#16784f', '#14915f', '#10ac6e', '#0bc77e', '#04e38d', '#00ff9d'];
...
export const intakeCategories = [
  ...
  { type: 'Sabzi', amount: 0,cal:150, color: intakeColors[4] },
  ...
  { type: 'Milk', amount: 0,cal:42, color: intakeColors[9] },
];
...
export const workoutCategories = [
  ...
  { type: 'Circuit training', amount: 0,cal:200, color: workoutColors[7] },
  { type: 'Dancing', amount: 0,cal:130, color: workoutColors[8] },
  { type: 'Football', amount: 0,cal:315, color: workoutColors[9] },
  { type: 'BasketBall', amount: 0,cal:260, color: workoutColors[10] },
];
